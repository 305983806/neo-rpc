...
public class ServiceRegistry {
    ...
    /**
     * 实现服务注册功能
     * 我们首先创建了一个名为 registry 的根节点，应该节点是持久类型的，因为它有子节点。
     * 随后创建了一个包含服务名称的 service 节点，该节点仍然是持久的。
     * 最后创建了一个对应服务地址的 address 节点，该节点是临时类型的，因为它不再有子节点，而且当客户端与服务端断开连接后，Zookeeper
